...
<?php include("../include/menu.php"); ?>
    ...
    <tr>
          <td width="100%" align="center" class="textos_form"><div class="titulo_formulario">Editar Proyectos</div>
    </tr>
  </table>
...
<form name="enviar" method="POST" id="enviar">
    ...
    <tr class="textos_form">
      <td width="50" align="center" bgcolor="#F3F3F3" class="textos_form" >Codigo
	...
	<tr>
      		...
      		<td align="center" bgcolor="#FFFFFF" ><?php echo $row_CONSULTA['ID_INMUEBLES_GRUPO']; ?>
      			...
      			<td bgcolor="#FFFFFF" ><?php echo $row_CONSULTA['NOMBRE_GRUPO']; ?>
   				<td bgcolor="#FFFFFF" ><a href="grupo_edit.php?ID_GRUPO=<?php echo $row_CONSULTA['ID_INMUEBLES_GRUPO']; ?>"><img src="../image/icon_doc.png" width="24" height="24" /></a>
	...
	<img src="../image/Delete-iconbw.png" width="24" height="24" />
