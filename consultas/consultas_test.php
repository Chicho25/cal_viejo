   ...
   $("#combo1").change(function () {
   		$("#combo1 option:selected").each(function () {
			//alert($(this).val());
				...
				$.post("combo1_test.php", { elegido: elegido }, function(data){
				$("#combo2").html(data);
				$("#combo3").html("");
				$("#combo4").html("");
				$("#combo5").html("");
...
<body>
<?php $opcion_menu=2; ?>
<?php include("../include/menu.php"); ?><table width="1000" align="center" class="ui-widget-header" >
	<tr>
...
<div id="accordion" style="height:400px; width:1000px" align="left">
    ...
    <h3><a href="#">Graficas Partidas</a></h3>
    <div>Graficas de las partidas</div>
</div></div>
</body>
</html>
<?php
