...
<?php include("../include/menu.php"); ?><table width="1100" align="center" class="ui-widget-header" >
	<tr>
	<td width="100%" align="center" class="textos_form"><div class="titulo_formulario">Consulta de Partidas</div></tr>
    <tr>
	<td width="100%" align="center" class="textos_form">
    <form action="suma.php" method="post">
    <input name="actualizar" type="submit" value="Actualizar"></form>
    </tr>
    </table>
