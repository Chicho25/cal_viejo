...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO inmuebles_master (ID_INMUEBLES_GRUPO, CODIGO, NOMBRE, ID_INMUEBLES_TIPO, AREA, PRECIO_PREVENTA, PRECIO_OFERTA, PRECIO_REAL, DISPONIBLE, ID_PARTIDA_COMISION, PORCENTAJE_COMISION) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<?php include("../include/menu.php"); ?>
  ...
  <table width="1100" align="center" class="ui-widget-header" >
    <tr>
      <td width="100%" align="center" class="textos_form"><div class="titulo_formulario">Nuevo Inmueble</div>
    </tr>
  </table>
...
do {  
?>
          <option value="<?php echo $row_GRUPO['ID_INMUEBLES_GRUPO']?>" ><?php echo $row_GRUPO['NOMBRE']?></option>
          <?php
...
?>
    ...
    <tr valign="baseline">
      ...
      <td align="left" nowrap="nowrap" bgcolor="#f3f3f3"><span id="sprytextfield1">
        <input type="text" name="CODIGO" value="" size="8" />
      </span></td>
...
?>
    ...
    <tr valign="baseline">
      ...
      <td colspan="3" bgcolor="#f3f3f3"><span id="sprytextfield3">
        <input type="text" name="AREA" value="0" size="32"  />
    ...
    <tr valign="baseline">
      ...
      <input type="text" name="PRECIO_PREVENTA" value="0" size="8" />
<span class="textfieldInvalidFormatMsg">Debe ser numerico</span></span></td>
      ...
      <td width="246" align="left" nowrap="nowrap" bgcolor="#f3f3f3"><span id="sprytextfield5">
        <input type="text" name="PRECIO_OFERTA" value="0" size="6" />
      <span class="textfieldInvalidFormatMsg">Debe ser numerico</span></span></td>
      ...
      <input type="text" name="PRECIO_REAL" value="0" size="6" />
<span class="textfieldInvalidFormatMsg">Debe ser numerico</span></span></td>
    </tr>
    <tr valign="baseline">
      ...
      <td colspan="3" bgcolor="#f3f3f3"><span class="textos_form">
        <input name="DISPONIBLE" type="checkbox" id="DISPONIBLE" checked="checked" />
        </span></td>
    </tr>
    <tr valign="baseline">
	...
	do {  
	?>
          <option value="<?php echo $row_partidas['ID']?>"<?php if (!(strcmp($row_partidas['ID'], 0))) {echo "selected=\"selected\"";} ?>>[ID:<?php echo $row_partidas['ID']?>] <?php echo $row_partidas['DESCRIPCION_COMPLETA']?></option>
          <?php
...
?>
    ...
    <tr valign="baseline">
      ...
      <td colspan="3" bgcolor="#f3f3f3"><span id="sprytextfield7">
        <input type="text" name="PORCENTAJE_COMISION" value="5" size="6" />
      <span class="textfieldInvalidFormatMsg">Debe ser numerico</span></span></td>
    </tr>
    <tr valign="baseline">
