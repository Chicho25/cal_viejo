<?php
/*Definiciones*/
$formulario="inmuebles00-busqueda";
?>
...
mysql_select_db($database_conexion, $conexion);
$query_TIPO = "SELECT ID_INMUEBLES_TIPO, NOMBRE FROM inmuebles_tipo";
...
<form action="listado.php" method="get" id="enviar">
    ...
    <tr>
          <td width="252" align="right" bgcolor="#F3F3F3" class="textos_form_derecha" >Codigo:
      <td colspan="5" bgcolor="#F3F3F3" ><label for="ID_INMUEBLES_MOV"></label>
        <input type="text" name="CODIGO_INMUEBLE" id="CODIGO_INMUEBLE" />
      <input name="col" type="hidden" id="col" value="NOMBRE_INMUEBLE,NOMBRE_GRUPO,NOMBRE_INMUEBLE" />      <input name="orden" type="hidden" id="orden" value="1" />      <input name="PRECIO_REAL" type="hidden" id="PRECIO_REAL" />          </tr>
    <tr>
...
Proyecto: 
      <td width="208" align="left" bgcolor="#F3F3F3" class="textos_form_derecha" ><select name="COD_PROYECTO" id="COD_PROYECTO">
...
?>
      ...
      <td width="242" bgcolor="#F3F3F3" ><select name="ID_INMUEBLE" id="ID_INMUEBLE">
      	<option value="0">Todos</option>
		</select>      
      </tr>
    <tr>
          <td width="252" align="right" bgcolor="#F3F3F3" class="textos_form_derecha" >Tipo:
          <td width="208" bgcolor="#F3F3F3" ><label for="ID_TIPO_INMUEBLE"></label>
            <select name="ID_TIPO_INMUEBLE" id="ID_TIPO_INMUEBLE">
            <option value="" >Todos</option>
              <?php
do {  
?>
              <option value="<?php echo $row_TIPO['ID_INMUEBLES_TIPO']?>"><?php echo $row_TIPO['NOMBRE']?></option>
              <?php
...
?>
      ...
      <td width="76" align="left" bgcolor="#F3F3F3" class="textos_form_derecha" >Status:      
      <td align="left" bgcolor="#F3F3F3" class="textos_form" ><label for="VENDIDO"></label>
        <select name="VENDIDO" id="VENDIDO">
          <option value="" >Todos</option>
          <option value="1" >Vendido</option>
          <option value="0">Por Vender</option>
        </select>
