...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  ...
  $Result1 = mysql_query($updateSQL, $conexion) or die(mysql_error());
   ...
   aud($_SESSION['i'],$ids,'Edicion de chequera con el id ',30);
   ?>
...
<?php //include("../include/menu.php"); ?>
    ...
    <tr>
          <td width="100%" align="center" class="textos_form"><div class="titulo_formulario">Editar Chequera</div>
    </tr>
  </table>
...
?>
    ...
    <tr valign="baseline">
      <td align="right" nowrap="nowrap" bgcolor="#F3F3F3" class="textos_form_derecha">Margen  superior del cheque:</td>
      <td bgcolor="#F3F3F3"><input name="MARGEN_TOPE" type="text" id="MARGEN_TOPE" value="<?php echo $row_EDITAR['MARGEN_TOPE']; ?>" size="15" /></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr>
      ...
      <td align="center" bgcolor="#F3F3F3" class="textos_form" >			
          ...
          <?php do { ?>
   		  ...
   		  <td align="left" bgcolor="#FFFFFF" ><?php if($row_CONSULTAS['TIENE_MOVIMIENTOS']==1){ ?><img src="../image/Delete-iconbw.png" width="24" height="24" /><?php } else { ?><a href="del.php?ID_CHEQUERA=<?php echo $row_CONSULTAS['ID_CHEQUERA']; ?>"><img src="../image/Delete-icon.png" width="24" height="24" /></a> <?php } ?>				  </td>				          	</tr>
