...
if ((isset($_GET['ID_INMUEBLES_MOV'])) && ($_GET['ID_INMUEBLES_MOV'] != "")) {
  ...
  $deleteGoTo ="edit2.php?ID_INMUEBLES_MOV=&ID_PROYECTO=&ID_GRUPO=&FECHA_VENTA_DATE=&ID_CLIENTE=&MONTO_VENTA=&FECHA_VENTA_DATE=&FECHA_HASTA=&CODIGO_INMUEBLE=&col=FECHA_VENTA_DATE&orden=1";
