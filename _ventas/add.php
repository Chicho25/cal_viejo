...
<?php $opcion_menu=2; ?>
    ...
    <tr>
          <td width="100%" align="center" class="textos_form"><div class="titulo_formulario">Nueva Venta</div>
    </tr>
    ...
    <tr>
        ...
        Proyecto:
      <td width="70%" bgcolor="#F3F3F3" ><select name="combo1" id="combo1">
...
?>
    ...
    <tr>
      ...
      <td width="70%" bgcolor="#F3F3F3" ><select name="GRUPO" id="GRUPO">
          <option>Seleccione...................</option>
        </select>
    </tr>
    <tr>
          <td align="right" bgcolor="#F3F3F3" class="textos_form_derecha" >Inmueble:
      <td width="70%" bgcolor="#F3F3F3" ><select name="INMUEBLE" id="INMUEBLE">
          <option>Seleccione...................</option>
        </select>
    </tr>
    <tr>
          <td align="right" bgcolor="#F3F3F3" class="textos_form_derecha" >Fecha:
      <td width="70%" bgcolor="#F3F3F3" ><input name="fecha" type="text" id="fecha" />
    </tr>
    <tr>
          <td align="right" bgcolor="#F3F3F3" class="textos_form_derecha" >Cliente:
      <td width="70%" bgcolor="#F3F3F3" ><select name="id_pro_cli" id="combobox" title="cliente" style="width: 300px; font-size:10px" width="300">
...
?>
    ...
    <tr>
      ...
      <td width="60%" bgcolor="#F3F3F3" ><label for="textfield2"></label>
        <input name="monto" type="text" class="textos_form_derecha" id="monto" value="0" onblur="calculateSum()" onchange="calculateSum()" />
    </tr>
    <tr>
    ...
    <ul></ul>
          ...
          <table width="100%" border="0" cellpadding="2" cellspacing="2" class="atable">
              ...
              <?php do { ?>
                <tr>
                <td width="51%"><?php echo $row_vendedores['NOMBRE']?>
                    <input name="VENDEDOR<?php echo $row_vendedores['ID_PRO_CLI_MASTER']?>" type="hidden" value="<?php echo $row_vendedores['ID_PRO_CLI_MASTER']?>" /></td>
                <td width="20%">
                    <input name="COMISION<?php echo $row_vendedores['ID_PRO_CLI_MASTER']?>" type="text" id="amr" class=' amr textos_form_derecha' value="0" size="4" />
                    % Comision</td>
                <td width="29%">&nbsp;</td>
              </tr>
                ...
                <td width="20%" bgcolor="#CCCCCC"><strong><span id="sum">0</span>% Comision Total</strong></td>
                <td width="29%" bgcolor="#CCCCCC"><strong>$<span id="monto_total">0</span> Comision Total</strong></td>
            </tr>
            </table>
    </tr>
        <tr>
          <td colspan="2" align="center" class="textos_form" ><input name="documentos" type="hidden" id="documentos" value="1" />
            <label for="documentos"></label>          
        <!--Generar Documentos de Comisiones Automaticamente--></tr>
    <tr>
          <td colspan="2" align="center" class="textos_form" ><input type="submit" name="button" id="button" value="Guardar" />
    </tr>
</table>
    </form>
