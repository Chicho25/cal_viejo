    ...
    <ul></ul>
          ...
          <table width="100%" border="0" cellpadding="2" cellspacing="2" class="atable">
              ...
              <?php do { ?>
                ...
                <td width="20%">
                    <input name="COMISION<?php echo $row_vendedores['ID_PRO_CLI_MASTER']?>" type="text" class=' amr textos_form_derecha' id="amr" value="<?php echo $row_vendedores['PORCENTAJE_COMISION']; ?>" size="4" readonly="readonly" />
                    % Comision</td>
                <td width="29%">&nbsp;</td>
              </tr>
