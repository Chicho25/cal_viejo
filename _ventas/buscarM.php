...
<?php //include("../include/menu.php"); ?>
    ...
    <tr>
          <td width="100%" align="center" class="textos_form"><div class="titulo_formulario">Buscar Ventas y Comisiones</div>
    </tr>
  </table>
<?php include("_menuM.php"); ?>
<form action="lista.php" method="get" id="enviar">
