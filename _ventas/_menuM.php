...
function goDim(FRM,BTN)
{
  ...
  <table border="0"  align="center" cellpadding="4" cellspacing="0"><form action="#" method="get" id="enviar" name="groovyform">
        <tr >
          <?php if (validador(19,$_SESSION['i'],"inc")==1){?><td align="center" bgcolor="#6FA7D1" width="1100" ><!--<input type="button" name="groovybtn1" class="groovybutton" value=" Insertar" title="" onMouseOver="goLite(this.form.name,this.name)" onMouseOut="goDim(this.form.name,this.name)" onClick="parent.location='add.php'">--><?php } ?>            <input type="button" name="groovybtn2" class="groovybutton" value="  Buscar" title="" onmouseover="goLite(this.form.name,this.name)" onmouseout="goDim(this.form.name,this.name)" onClick="parent.location='buscarM.php'" /></td>
        </tr></form>
