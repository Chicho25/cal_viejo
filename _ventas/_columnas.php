...
$str_col=$col1.'='.$valor_col1.'&'.$col2.'='.$valor_col2.'&'.$col3.'='.$valor_col3.'&'.$col4.'='.$valor_col4.'&'.$col5.'='.$valor_col5.'&'.$col6.'='.$valor_col6.'&'.$col7.'='.$valor_col7.'&'.$col8.'='.$valor_col8.'&'.$col9.'='.$valor_col9.'&'.$col10.'='.$valor_col10;

$url_col1='<a title="Ordenar" href="edit2.php?'.$str_col.'&col='.$col1.'&orden='.$orden.'" ';
$url_col2='<a title="Ordenar" href="edit2.php?'.$str_col.'&col='.$col2.'&orden='.$orden.'" ';
$url_col3='<a title="Ordenar" href="edit2.php?'.$str_col.'&col='.$col3.'&orden='.$orden.'" ';
$url_col4='<a title="Ordenar" href="edit2.php?'.$str_col.'&col='.$col4.'&orden='.$orden.'" ';
$url_col5='<a title="Ordenar" href="edit2.php?'.$str_col.'&col='.$col5.'&orden='.$orden.'" ';
$url_col6='<a title="Ordenar" href="edit2.php?'.$str_col.'&col='.$col6.'&orden='.$orden.'" ';
$url_col9='<a title="Ordenar" href="edit2.php?'.$str_col.'&col='.$col9.'&orden='.$orden.'" ';
$url_col10='<a title="Ordenar" href="edit2.php?'.$str_col.'&col='.$col10.'&orden='.$orden.'" ';
