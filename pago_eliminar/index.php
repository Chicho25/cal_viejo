...
<table width="1100" align="center" class="ui-widget-header" >
	<tr>
		<td width="100%" align="center" class="textos_form"><div class="titulo_formulario">Consulta de Pagos</div>
	</tr>
</table><form action="del01.php" method="get">
<table width="1100" border="0" cellpadding="0" cellspacing="2" align="center">
	...
	<tr>
	  ...
	  <td width="33%" colspan="3" bgcolor="#F0F0F0"><select name="PROYECTO" id="PROYECTO">
...
?>
	...
	<tr>
		...
		<td width="33%" colspan="3" bgcolor="#F0F0F0"><label for="TIPO"></label>
...
?>
	...
	<tr>
	  ...
	  <td colspan="3" bgcolor="#F0F0F0"><label for="STATUS"></label>
