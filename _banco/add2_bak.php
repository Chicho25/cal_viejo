...
<input name="ID_PAGO" type="text" class="textos_form_derecha" id="ID_PAGO" value="<?php echo $row_PAGOS['ID_PAGO']; ?>" /></td>
	...
	<tr>
	  ...
	  <td bgcolor="#F0F0F0" class="textos_form"><input type="hidden" name="ID_CUENTA" id="ID_CUENTA"  value="<?php echo $_GET['ID_CUENTA']; ?>"/><input name="textfield" type="text" class="textos_form" id="textfield" value="<?php echo $_GET['TEXTO_CUENTA']; ?>" size="70" readonly="readonly" />
