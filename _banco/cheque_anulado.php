...
$query_cuentas = "SELECT * FROM cuentas_bancarias WHERE ID_CUENTA_BANCARIA=".$_GET['ID_CUENTA'];
...
<table width="1100" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<input name="ID_CUENTA" type="hidden" id="ID_CUENTA" value="<?php echo $row_cuentas['ID_CUENTA_BANCARIA']; ?>" />
		<input name="ID_CHEQUERA" type="hidden" id="ID_CHEQUERA" value="<?php echo $_GET['ID_CHEQUERA']; ?>" />
		<input type="hidden" name="PROYECTO" id="PROYECTO" value="<?php echo $_GET['COD_PROYECTO']; ?>" /></td>
	</tr>
	<tr>
