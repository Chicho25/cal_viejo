...
<table width="1100" align="center" class="ui-widget-header" >
	<tr>
		<td width="100%" align="center" class="textos_form"><div class="titulo_formulario">Pagos - <?php echo $row_PROYECTO['NOMBRE']; ?></div>
	</tr>
</table><form action="pago2.php" method="POST">
<table width="1100" border="0" cellpadding="0" cellspacing="0" align="center">
	<tr>
		<td align="center" bgcolor="#F0F0F0" class="textos_form">Proveedor
			<span id="spryselect1">
...
?>
			...
			<input name="button" type="submit" class="textos_form" id="button" value="Buscar" />
