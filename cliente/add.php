...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO pro_cli_master (TIPO, NOMBRE, CONTACTO, ID_PRO_CLI_GRUPO, ID_TRIBUTARIA_CEDULA, DIRECCION, TELEFONO_FIJO_1, TELEFONO_FIJO_2, TELEFONO_MOVIL_1, TELEFONO_MOVIL_2, EMAIL_1, EMAIL_2, WEB_SITE, OBSERVACIONES) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
	<table width="1100" align="center" class="textos_form" bgcolor="#F5F5F5"">
		<tr valign="baseline">
			...
			<td width="350" align="left"><input name="GRUPO" type="text" value="1" size="50" readonly="readonly" /></td>
		</tr>
		<tr valign="baseline">
