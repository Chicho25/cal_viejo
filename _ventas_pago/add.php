...
?>
      ...
      <input name="ID_CUENTA_BANCARIA" type="hidden" id="ID_CUENTA_BANCARIA" value="<?php echo $row_cuenta['ID_CUENTA']; ?>" /> -->

	    <select name="ID_CUENTA_BANCARIA" id="ID_CUENTA_BANCARIA">
	      <?php
do {  
?>
	      <option value="<?php echo $row_cuenta['ID_CUENTA']?>"><?php echo $row_cuenta['NOMBRE_BANCO']; ?>-<?php echo $row_cuenta['NUMERO_CUENTA']; ?></option>
	      <?php
