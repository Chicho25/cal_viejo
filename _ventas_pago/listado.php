...
$where=" WHERE vista_pagos.modulo='2' ";
...
<?php include("../include/funciones.php"); ?>
	<table width="1100" align="center" class="ui-widget-header" >
		<tr>
			<td width="100%" align="center" class="textos_form"><div class="titulo_formulario">Pagos Recibidos</div>
		</tr>
	</table>
...
<table width="1100" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999">
	<tr class="textos_form">
		<td width="29" align="center" bgcolor="#CCCCCC">ID</td>
		<td width="176" align="center" bgcolor="#CCCCCC">Proyecto</td>
		<td width="187" align="center" bgcolor="#CCCCCC">Cliente</td>
		<td width="200" align="center" bgcolor="#CCCCCC">Descripcion</td>
		<td width="143" align="center" bgcolor="#CCCCCC">Tipo</td>
		<td width="169" align="center" bgcolor="#CCCCCC">Numero</td>
		<td width="116" align="center" bgcolor="#CCCCCC">Fecha</td>
		<td width="175" align="center" bgcolor="#CCCCCC">Monto</td>
		<?php if (validador(21,$_SESSION['i'],"eli")==1){?><td width="29" align="center" bgcolor="#CCCCCC">&nbsp;</td><?php } ?>
	</tr>
	<?php 	
	$MONTO_TOTAL=0;
	do {  
...
<tr>
			...
			<td width="128" align="center" bgcolor="#FFFFFF"><?php echo $row_CONSULTA['ID_PAGO']; ?></td>
			<td width="176" align="center" bgcolor="#FFFFFF"><?php echo $row_CONSULTA['COD_PROYECTO']; ?></td>
			<td width="187" bgcolor="#FFFFFF"><?php echo $row_CONSULTA['NOMBRE_PRO_CLI']; ?></td>
			<td width="200" align="left" bgcolor="#FFFFFF"><?php echo $row_CONSULTA['DESCRIPCION_PAGO']; ?></td>
			<td width="143" bgcolor="#FFFFFF"><?php echo $row_CONSULTA['TIPO_PAGO']; ?></td>
			<td align="center" bgcolor="#FFFFFF"><?php echo $row_CONSULTA['NUMERO_PAGO']; ?></td>
			<td width="116" align="center" bgcolor="#FFFFFF"><?php echo $row_CONSULTA['FECHA']; ?></td>
			<td width="175" align="right" bgcolor="#FFFFFF"><?php echo $row_CONSULTA['MONTO_PAGADO']; ?></td>
            <?php if (validador(21,$_SESSION['i'],"eli")==1){?><td align="center" bgcolor="#FFFFFF"><!--<img src="../image/icon_doc.png" width="24" height="24" />--><!--<img src="../image/cheque.png" width="24" height="24" />-->
			<a href="#" title="Eliminar este Pago" ><img alt="Eliminar Registro"  src="../image/Delete-icon.png" width="24" height="24" onClick="openDialog(<?php echo $row_CONSULTA['ID_PAGO']; ?>)" /></a></td>
			<?php } ?>
	...
	<?php } while ($row_CONSULTA = mysql_fetch_assoc($CONSULTA)); ?>
		...
		<td width="176" align="center" bgcolor="#CCCCCC"></td>
		...
		<td width="169" align="center" bgcolor="#CCCCCC"></td>
		<td width="116" align="center" bgcolor="#CCCCCC">Total</td>
		<td width="175" align="right" bgcolor="#CCCCCC"><?php echo number_format($MONTO_TOTAL,2) ?></td>
