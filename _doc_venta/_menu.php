...
function goDim(FRM,BTN)
{
  ...
  <table width="1100" border="0" align="center" cellpadding="4" cellspacing="0"><form action="#" method="get" id="enviar" name="groovyform">
        <tr>
          <td width="550" align="right" bgcolor="#6FA7D1"><input type="button" name="groovybtn1" class="groovybutton" value=" Insertar" title="" onMouseOver="goLite(this.form.name,this.name)" onMouseOut="goDim(this.form.name,this.name)" onClick="parent.location='add_proyecto.php'"></td>
          <td bgcolor="#6FA7D1"><input type="button" name="groovybtn2" class="groovybutton" value="  Buscar" title="" onmouseover="goLite(this.form.name,this.name)" onmouseout="goDim(this.form.name,this.name)" onClick="parent.location='index.php'" /></td>
        </tr></form>
