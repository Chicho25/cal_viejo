...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE pro_cli_master SET TIPO=%s, NOMBRE=%s, CONTACTO=%s, ID_PRO_CLI_GRUPO=%s, ID_TRIBUTARIA_CEDULA=%s, VENDEDOR=%s, DIRECCION=%s, TELEFONO_FIJO_1=%s, TELEFONO_FIJO_2=%s, TELEFONO_MOVIL_1=%s, TELEFONO_MOVIL_2=%s, EMAIL_1=%s, EMAIL_2=%s, WEB_SITE=%s, OBSERVACIONES=%s, BENEFICIARIOS=%s WHERE ID_PRO_CLI_MASTER=%s",
...
<table width="1100" align="center" class="ui-widget-header" >
	<tr>
	<td width="1100" align="center" class="textos_form"><div class="titulo_formulario">Editar Proveedor</div></tr></table>
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form2" id="form2">
	<table width="1100" align="center" class="textos_form" bgcolor="#F5F5F5">
		<tr valign="baseline">
		  ...
		  <td width="174" align="left">Vendedor:<input name="VENDEDOR" type="checkbox" id="VENDEDOR" value="Si" <?php if (!(strcmp($row_editar_proveedor['VENDEDOR'],"1"))) {echo "checked=\"checked\"";} ?> /></td>
		...
		<tr valign="baseline">
			...
			<td width="350" colspan="2" align="left"><input type="text" name="NOMBRE" value="<?php echo $row_editar_proveedor['NOMBRE']; ?>" size="50" /></td>
		...
		<tr valign="baseline">
			...
			<td colspan="4" align="left"><input type="text" name="CONTACTO" value="<?php echo $row_editar_proveedor['CONTACTO']; ?>" size="50" /></td>
		</tr>
        <td width="200" align="right" valign="top" nowrap="nowrap">Beneficiarios:</td>
		  <td colspan="4" align="left"><p>
		    <label for="BENEFICIARIO"></label>
		    <input name="BENEFICIARIO" type="text" id="BENEFICIARIO" value="<?php echo $row_editar_proveedor['BENEFICIARIOS']; ?>" size="133" />
		  </p>
	      <p>Nota:<span class="textos_formrojo">Los beneficiarios deben estar separados por punto y coma (;) ejemplo: (Pedro Perez; Juan Perez; Maria Gonzalez) hasta un maximo de 5 Beneficiarios</span></p></td>
  <tr valign="baseline">
			<td width="200" align="right" valign="top" nowrap="nowrap">Direccion:</td>
			<td colspan="4" align="left"><textarea name="DIRECCION" cols="102" rows="3"><?php echo $row_editar_proveedor['DIRECCION']; ?></textarea></td>
		</tr>
		<tr valign="baseline">
			<td width="200" align="right" nowrap="nowrap">Telefono Fijo 1:</td>
			<td colspan="2" align="left"><input type="text" name="TELEFONO_FIJO_1" value="<?php echo $row_editar_proveedor['TELEFONO_FIJO_1']; ?>" size="50" /></td>
		...
		<tr valign="baseline">
			...
			<td colspan="2" align="left"><input type="text" name="TELEFONO_MOVIL_1" value="<?php echo $row_editar_proveedor['TELEFONO_MOVIL_1']; ?>" size="50" /></td>
		...
		<tr valign="baseline">
			...
			<td colspan="2" align="left"><input type="text" name="EMAIL_1" value="<?php echo $row_editar_proveedor['EMAIL_1']; ?>" size="50" /></td>
		...
		<tr valign="baseline">
			...
			<td colspan="4" align="left"><input type="text" name="WEB_SITE" value="<?php echo $row_editar_proveedor['WEB_SITE']; ?>" size="100" /></td>
		</tr>
		<tr valign="baseline">
			<td width="200" align="right" valign="top" nowrap="nowrap">Observaciones:</td>
			<td colspan="4" align="left"><textarea name="OBSERVACIONES" cols="102" rows="3"><?php echo $row_editar_proveedor['OBSERVACIONES']; ?></textarea></td>
		</tr>
		<tr valign="baseline">
			<td colspan="5" align="center" nowrap="nowrap"><input type="submit" value="Modificar" /></td>
		</tr>
	</table>
