...
{
	if($where!=""){
		$where=$where." AND COD_TIPO IN (1,3) ";
	}
	else
	{
		$where=" WHERE COD_TIPO IN (1,3) ";
	}
}
	$VENDEDOR="No";
if(isset($_GET['VENDEDOR'])){
	...
	if($where!=""){
		$where=$where." AND VENDEDOR ='".$_GET['VENDEDOR']."' ";
	}
	else
	{
		$where=" WHERE VENDEDOR='".$_GET['VENDEDOR']."' ";
	}
}
else{
	$VENDEDOR="No";
...
<table width="1100" align="center" class="ui-widget-header" >
	<tr>
		<td width="100%" align="center" class="textos_form"><div class="titulo_formulario">Proveedores</div>
	</tr>
</table>
...
<table width="1100" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999">
	<tr class="textos_form">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="4">
			<tr>
				<td align="center" bgcolor="#E5E5E5"><?php if (validador(11,$_SESSION['i'],"inc")==1){?><input type="button" name="button3" id="button3" value="Insertar" onClick="parent.location='add.php'"/>				  <?php } ?>				  <input type="button" name="button" id="button" value="Buscar" onClick="parent.location='index.php'"/></td>
			</tr>
			<tr>
				<td align="center"><table width="400" border="0" cellpadding="2" cellspacing="0" class="textos_form">
					<tr>
...
<?php if ($totalRows_CONSULTA > 0) { // Show if recordset not empty ?>
	<table width="1100" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999">
		<tr class="menu">
			<td width="165" align="center" bgcolor="#cccccc">
			...
			<td width="168" align="center" bgcolor="#cccccc" class="textos_form">
			...
			<td width="280" align="center" bgcolor="#cccccc" class="textos_form">
			...
			<td width="224" align="center" bgcolor="#cccccc" class="textos_form">
			...
			<td width="161" align="center" bgcolor="#cccccc" class="textos_form">
	   ...
	   <?php if (validador(11,$_SESSION['i'],"edi")==1){?> <td colspan="2" align="center" bgcolor="#cccccc">&nbsp;</td><?php } ?>
		</tr>
		<?php do { ?>
	...
	<?php }?> >
				...
				<?php if (validador(11,$_SESSION['i'],"edi")==1){?><td width="31" align="right"><a href="editar.php?ID_PRO_CLI=<?php echo $row_CONSULTA['ID_PRO_CLI']; ?>"><img src="../image/icon_doc.png" width="24" height="24" /></a>
		    <input name="CODIGO" type="hidden" id="CODIGO" value="<?php echo $_GET['CODIGO']; ?>" /></td><?php } ?>
				<?php if (validador(11,$_SESSION['i'],"eli")==1){?><td width="44" align="right" ><?php if (($row_CONSULTA['DOCUMENTOS']==0)&&($row_CONSULTA['TIENE_CONTRATOS']==0)){?>
				<a href="#" ><img alt="Eliminar Registro"  src="../image/Delete-icon.png" width="24" height="24" onClick="openDialog(<?php echo $row_CONSULTA['ID_PRO_CLI']; ?>)" /></a><input name="CODIGO" type="hidden" id="CODIGO" value="<?php echo $row_CONSULTA['ID_PRO_CLI']; ?>" /><?php }?></td><?php } ?>
			</tr>
