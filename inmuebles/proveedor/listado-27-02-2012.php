...
<table width="1100" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999">
	<tr class="textos_form">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="4">
			<tr>
				<td align="center" bgcolor="#E5E5E5"><?php if (validador(19,$_SESSION['i'],"inc")==1){?><input type="button" name="button3" id="button3" value="Insertar" onClick="parent.location='add.php'"/>				  <input type="button" name="button" id="button" value="Buscar" onClick="parent.location='index.php'"/><?php } ?></td>
			</tr>
			<tr>
...
<?php if ($totalRows_CONSULTA > 0) { // Show if recordset not empty ?>
	...
	<?php }?> >
		    ...
		    <input name="CODIGO" type="hidden" id="CODIGO" value="<?php echo $_GET['CODIGO']; ?>" /></td><?php } ?>
				...
				<a href="#" ><img alt="Eliminar Registro"  src="../image/Delete-icon.png" width="24" height="24" onClick="openDialog(<?php echo $row_CONSULTA['ID_PRO_CLI']; ?>)" /></a><input name="CODIGO" type="hidden" id="CODIGO" value="<?php echo $row_CONSULTA['ID_PAGO']; ?>" /><?php }?></td><?php } ?>
			</tr>
