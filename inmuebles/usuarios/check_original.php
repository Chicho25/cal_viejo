  ...
  <table border="0" align="center" bgcolor="#CCCCCC">
	...
	?>
      ...
      <tr align="center" bgcolor="#CCCCCC" class="Campos">
        ...
        <td width="63">
          <p>
            <input type="hidden" name="F_VIEW-<?php echo $row_grupos['ID_MENU']; ?>" id="hiddenField" value="0" />
            <input <?php if (!(strcmp(substr($row_grupos['DETALLE_ACCESO'],0,1),1))) {echo "checked=\"checked\"";} ?> class="navegar" type="checkbox" name="F_VIEW-<?php echo $row_grupos['ID_MENU']; ?>" id="left" value="1" />
        </p></td>
        <td width="63">
          <input type="hidden" name="F_INSERT-<?php echo $row_grupos['ID_MENU']; ?>" id="hiddenField" value="0" />
          <input <?php if (!(strcmp(substr($row_grupos['DETALLE_ACCESO'],1,1),1))) {echo "checked=\"checked\"";} ?> class="incluir" type="checkbox" name="F_INSERT-<?php echo $row_grupos['ID_MENU']; ?>" id="checkbox" value="1" />
</td>
        <td width="63">
        
                  <input type="hidden" name="F_UPDATE-<?php echo $row_grupos['ID_MENU']; ?>" id="hiddenField" value="0" />
          <input <?php if (!(strcmp(substr($row_grupos['DETALLE_ACCESO'],2,1),1))) {echo "checked=\"checked\"";} ?> class="editar" type="checkbox" name="F_UPDATE-<?php echo $row_grupos['ID_MENU']; ?>" id="checkbox" value="1" />
        </td>
        <td width="63">         
         <input type="hidden" name="F_DELETE-<?php echo $row_grupos['ID_MENU']; ?>" id="hiddenField" value="0" />
          <input <?php if (!(strcmp(substr($row_grupos['DETALLE_ACCESO'],3,1),1))) {echo "checked=\"checked\"";} ?> class="eliminar" type="checkbox" name="F_DELETE-<?php echo $row_grupos['ID_MENU']; ?>" id="checkbox" value="1" />
        </td>
           </tr>
      <?php 
	  $a=$a+1;
