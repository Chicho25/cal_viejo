	...
	?>
      ...
      <tr align="center" bgcolor="#CCCCCC" class="Campos">
        ...
        <td width="63"><label for="select"></label>
          <select name="F_N-<?php echo $row_grupos['ID_MENU']; ?>" id="F_N-<?php echo $row_grupos['ID_MENU']; ?>">
            <option value="1">PERMITIR</option>
            <option value="0">DENEGAR</option>
          </select></td>
        <td width="63"><select name="F_I-<?php echo $row_grupos['ID_MENU']; ?>2" id="F_I-<?php echo $row_grupos['ID_MENU']; ?>">
            <option value="1">PERMITIR</option>
            <option value="0">DENEGAR</option>
        </select></td>
        <td width="63"><select name="F_E-<?php echo $row_grupos['ID_MENU']; ?>2" id="F_E-<?php echo $row_grupos['ID_MENU']; ?>2">
            <option value="1">PERMITIR</option>
            <option value="0">DENEGAR</option>
        </select></td>
        <td width="63"><select name="F_D-<?php echo $row_grupos['ID_MENU']; ?>2" id="F_D-<?php echo $row_grupos['ID_MENU']; ?>3">
            <option value="1">PERMITIR</option>
            <option value="0">DENEGAR</option>
        </select></td>
           </tr>
