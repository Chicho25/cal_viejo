...
<form method="get" name="form2" action="_roles2.php">
  ...
  <table border="0" align="center" bgcolor="#CCCCCC">
    <tr align="center" valign="middle" class="ui-widget-header">
      <td width="233">Menus</td>
      <td width="76"><p>Navegar</p>
        <p>&nbsp;</p></td>
      <td width="43"><p>Incluir</p>
      <p>&nbsp;</p></td>
      <td width="58"><p>Editar</p>
      <p>&nbsp;</p></td>
      <td width="64"><p>Eliminar</p>
      <p>&nbsp;</p></td>
	...
	?>
      ...
      <tr align="center" bgcolor="#CCCCCC" class="Campos">
        <td width="233" align="left"><?php echo htmlentities($row_grupos['DESCRIPCION_MENU']); ?>
        ...
        <td width="43"><p>
          <label>
            <input type="checkbox" name="CheckboxGroup1" value="0" id="CheckboxGroup1_0" />
            Checkbox</label>
          <br />
          <label>
