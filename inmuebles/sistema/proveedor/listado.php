...
<?php if ($totalRows_CONSULTA > 0) { // Show if recordset not empty ?>
	<table width="1100" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999">
		<tr class="menu">
			...
			<td width="250" align="center" bgcolor="#cccccc" class="textos_form">
	...
	<?php }?> >
				...
				<td align="right"><a href="editar.php?ID_PRO_CLI=<?php echo $row_CONSULTA['ID_PRO_CLI']; ?>"><img src="../image/icon_doc.png" width="24" height="24" /></a>
		    <input name="CODIGO" type="hidden" id="CODIGO" value="<?php echo $_GET['CODIGO']; ?>" /></td>
				<td align="right" ><?php if ($row_CONSULTA['DOCUMENTOS']==0){?>
