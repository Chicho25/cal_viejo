...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO banco_cuentas (NUMERO_CUENTA, DESCRIPCION_CUENTA, ID_BANCO_MASTER, CODIGO_EMPRESA) VALUES (%s, %s, %s, %s)",
...
<?php include("../include/menu.php"); ?>
    ...
    <tr>
          <td width="100%" align="center" class="textos_form"><div class="titulo_formulario">A&ntilde;adir Cuenta</div>
    </tr>
  </table>
  ...
  <table width="1100" align="center">
    <tr valign="baseline">
      ...
      <td width="545" bgcolor="#F3F3F3"><span id="sprytextfield1">
        <input type="text" name="NUMERO_CUENTA" value="" size="32" />
    ...
    <tr valign="baseline">
      ...
      <td bgcolor="#F3F3F3"><span id="sprytextfield2">
        <input type="text" name="DESCRIPCION_CUENTA" value="" size="32" />
      <span class="textfieldRequiredMsg">Requerido.</span></span></td>
    </tr>
    <tr valign="baseline">
...
do {  
?>
        <option value="<?php echo $row_BANCOS['ID_BANCO_MASTER']?>" ><?php echo $row_BANCOS['NOMBRE']?></option>
        <?php
...
<p><br />
  ...
  <table width="1100" align="center">
    <tr>
      ...
      <td align="center" bgcolor="#F3F3F3" class="textos_form" >Descripcion      
      <td align="center" bgcolor="#F3F3F3" class="textos_form" >		
          ...
          <?php do { ?>
	          ...
	          <td align="left" bgcolor="#FFFFFF" ><a href="edit.php?ID_CUENTA_BANCARIA=<?php echo $row_CONSULTAS['ID_CUENTA']; ?>"><img src="../image/icon_doc.png" width="24" height="24" /></a>				
