...
<form name="enviar" method="GET" id="enviar" action="listado_01.php">
      <table width="1100" align="center" >
<!-- Busqueda Proyectos-->    
<?php include('../include/_combo_proyectos.php'); ?>
<!--Fin Proyectos-->
    <tr>
      <td width="398" align="right" bgcolor="#F3F3F3" class="textos_form_derecha" >Detallado:      
      <td align="left" bgcolor="#F3F3F3" ><label for="MONTO_ESTIMADO">
      	<input name="DETALLADO" type="checkbox" id="DETALLADO" value="1" />
      </label>      
      	</tr>
    <tr>
