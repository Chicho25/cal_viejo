...
if(isset($_POST['ALICUOTA'])){$alic=1;} else {$alic=0;}
if(isset($_POST['PORCENTAJE_ALICUOTA'])){$porc=$_POST['PORCENTAJE_ALICUOTA'];} else {$porc=0;}
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "enviar")) {
  $updateSQL = sprintf("UPDATE partidas SET MONTO_ESTIMADO=%s, DESCRIPCION=%s, DESCRIPCION_COMPLETA=%s, DESCRIPCION_CORTA=%s, ALICUOTA=%s, PORCENTAJE_ALICUOTA=%s WHERE ID=%s",
					   ...
					   GetSQLValueString($alic, "int"),
					   GetSQLValueString($porc, "double"),
...
$("document").ready(function(){
	...
	$("#ALICUOTA").change(function () {
   		//$("#ALICUOTA:checked").each(function () {
			//alert($("#ALICUOTA:checked").val());
				//elegido=$(this).val();
				if ($("#ALICUOTA:checked").val()=="on"){$("#PORCENTAJE_ALICUOTA").show();} else { $("#PORCENTAJE_ALICUOTA").hide(); $("#PORCENTAJE_ALICUOTA").val(0);}
...
Partida: 
    ...
    <tr>
      ...
      <td align="left" bgcolor="#F3F3F3" ><label for="PORCENTAJE_ALICUOTA"></label>
    ...
    <tr>
      ...
      <tr>
      <td width="398" align="right" bgcolor="#F3F3F3" class="textos_form_derecha" >Alicuota:      
      <td align="left" bgcolor="#F3F3F3" ><label for="PORCENTAJE_ALICUOTA"></label>
        <label for="DESCRIPCION_COMPLETA">
          <input <?php if (!(strcmp($row_CONSULTA['ALICUOTA'],1))) {echo "checked=\"checked\"";} ?> type="checkbox" name="ALICUOTA" id="ALICUOTA" />
        </label>      </tr>
      <tr>
      <td width="398" align="right" bgcolor="#F3F3F3" class="textos_form_derecha" >Porcentaje de la Alicuota:      
      <td align="left" bgcolor="#F3F3F3" ><label for="PORCENTAJE_ALICUOTA"></label>
        <input name="PORCENTAJE_ALICUOTA" type="text" class="textos_form_derecha" id="PORCENTAJE_ALICUOTA" value="<?php echo number_format($row_CONSULTA['PORCENTAJE_ALICUOTA'],2); ?>" />
        <label for="DESCRIPCION_COMPLETA"></label></tr>
      <!--<tr>
      <td width="398" align="right" bgcolor="#F3F3F3" class="textos_form_derecha" >Id de la Alicuota:      
      <td align="left" bgcolor="#F3F3F3" ><label for="PORCENTAJE_ALICUOTA"></label>
        <input name="ID_ALICUOTA" type="text" class="textos_form_derecha" id="ID_ALICUOTA" value="<?php echo $row_CONSULTA['ID_ALICUOTA']; ?>" />
        <label for="DESCRIPCION_COMPLETA"></label></tr>-->
    <tr>
