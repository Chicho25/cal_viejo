...
$query_CONSULTA = "SELECT * FROM vista_partidas ".$where." ".$_GET['ID_PARTIDA']." ".$_GET['NIVEL']." ORDER BY ".$ordenar;
...
mysql_select_db($database_conexion, $conexion);
$query_CONSULTA2 = "SELECT * FROM vista_partidas ".$where." ".$_GET['ID_PARTIDA2']."  ".$_GET['NIVEL']." ORDER BY ".$ordenar;
//echo $query_CONSULTA2;
//$query_limit_CONSULTA2 = sprintf("%s LIMIT %d, %d", $query_CONSULTA2, $startRow_CONSULTA2, $maxRows_CONSULTA);
  ...
  <table width="1100" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999">
	...
	if($row_CONSULTA['ALICUOTA']==1)
	{
      ...
      <tr style="font-family:Arial, Helvetica, sans-serif; font-size:12px" bgcolor=<?php echo $color ?> >
        ...
        <td align="center" >		<?php if(($row_CONSULTA['TIPO']==2)&&($row_CONSULTA['ALICUOTA']==0)){ ?>
          <a href="edit.php?ID_PARTIDA=<?php echo $row_CONSULTA['ID_PARTIDA']; ?>" title="Editar Partida"><img src="../image/icon_doc.png" width="24" height="24" /></a><?php }?></td>
        <td align="center" ><!--
      ...
      <?php } while ($row_CONSULTA = mysql_fetch_assoc($CONSULTA)); ?>
	      <tr class="menu">
      <td width="50" align="center" bgcolor="DBDBDB" class="textos_form"></td>
      <td width="100" align="center" bgcolor="DBDBDB" class="textos_form"></td>
      <td align="center" bgcolor="DBDBDB" class="textos_form"></td>
      <td width="150" align="right" bgcolor="#DBDBDB" class="textos_form"><?php echo number_format($MONTO1,2); ?></td>
      <td width="150" align="right" bgcolor="#DBDBDB" class="textos_form"><?php echo number_format($MONTO2,2); ?></td>
      <td width="150" align="right" bgcolor="#DBDBDB" class="textos_form"><?php echo number_format($MONTO3,2); ?></td>
      <td width="50" align="center" bgcolor="#DBDBDB">&nbsp;</td>
      <td width="50" align="center" bgcolor="#DBDBDB">&nbsp;</td>
    </tr>
	...
	do { ?>
    <?php
		$MONTO2_1=$MONTO2_1+$row_CONSULTA2['MONTO_ESTIMADO'];
	    $MONTO2_2=$MONTO2_2+$row_CONSULTA2['MONTO_PAGADO'];
	    $MONTO2_3=$MONTO2_3+$row_CONSULTA2['MONTO_ESTIMADO_DISPONIBLE'];
	 
		$color='#b3ffb3';
		$equis="../image/Delete-icon.png";
		$funcion='onClick="openDialog('. $row_CONSULTA2['ID_PARTIDA'].')"';
	if($row_CONSULTA2['ESTIMADO_EXCEDIDO']==1)
	{
		$color='#ffcaca';
		$equis="../image/Delete-iconbw.png";
		$funcion='';
	}
	if($row_CONSULTA2['ALICUOTA']==1)
	{
		$color='#ffff99';
		$equis="../image/Delete-iconbw.png";
		$funcion='';
		...
		?>
      <tr style="font-family:Arial, Helvetica, sans-serif; font-size:12px" bgcolor=<?php echo $color ?> >
        <td align="center"><?php echo $row_CONSULTA2['ID_PARTIDA']; ?></td>
        <td align="center"><?php echo $row_CONSULTA2['COD_PROYECTO']; ?></td>
        <td><?php echo $row_CONSULTA2['DESCRIPCION_COMPLETA']; ?></td>
        <td align="right"><?php echo number_format($row_CONSULTA2['MONTO_ESTIMADO'],2); ?></td>
        <td align="right"><?php echo number_format($row_CONSULTA2['MONTO_PAGADO'],2); ?></td>
        <td align="right"><?php echo number_format($row_CONSULTA2['MONTO_ESTIMADO_DISPONIBLE'],2); ?></td>
        <td align="center" >		<?php if(($row_CONSULTA2['TIPO']==2)&&($row_CONSULTA['ALICUOTA']==0)){ ?>
          <a href="edit.php?ID_PARTIDA=<?php echo $row_CONSULTA2['ID_PARTIDA']; ?>" title="Editar Partida"><img src="../image/icon_doc.png" width="24" height="24" /></a><?php }?></td>
        <td align="center" ><!--
          <a href="#" title="Eliminar Pagos" ><img alt="Eliminar Registro"  src="<?php echo $equis ?>" width="24" height="24" <?php echo $funcion; ?>)/></a>--></td>
      </tr>
      <?php } while ($row_CONSULTA2 = mysql_fetch_assoc($CONSULTA2)); ?>
	      <tr class="menu">
      <td width="50" align="center" bgcolor="#D4D4D4" class="textos_form"></td>
      <td width="100" align="center" bgcolor="#D4D4D4" class="textos_form"></td>
      <td align="center" bgcolor="#D4D4D4" class="textos_form"></td>
      <td width="150" align="right" bgcolor="#D4D4D4" class="textos_form"><?php echo number_format($MONTO2_1,2); ?></td>
      <td width="150" align="right" bgcolor="#D4D4D4" class="textos_form"><?php echo number_format($MONTO2_2,2); ?></td>
      <td width="150" align="right" bgcolor="#D4D4D4" class="textos_form"><?php echo number_format($MONTO2_3,2); ?></td>
      <td width="50" align="center" bgcolor="#D4D4D4">&nbsp;</td>
      <td width="50" align="center" bgcolor="#D4D4D4">&nbsp;</td>
    </tr>
	
	<tr class="menu">
      <td width="50" align="center"  class="textos_form"></td>
      <td width="100" align="center"  class="textos_form"></td>
      <td align="center" class="textos_form"></td>
      <td width="150" align="right" class="textos_form"><?php echo number_format($MONTO1+$MONTO2_1,2); ?></td>
      <td width="150" align="right"  class="textos_form"><?php echo number_format($MONTO2+$MONTO2_2,2); ?></td>
      <td width="150" align="right"  class="textos_form"><?php echo number_format($MONTO3+$MONTO2_3,2); ?></td>
