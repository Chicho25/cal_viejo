...
function goDim(FRM,BTN)
{
  ...
  <table width="1100" border="0" align="center" cellpadding="4" cellspacing="0"><form action="#" method="get" id="enviar" name="groovyform">
        <tr>
          <td width="550" align="right" bgcolor="#6FA7D1"><?php if (validador(20,$_SESSION['i'],"inc")==1){?><input type="button" name="groovybtn1" class="groovybutton" value=" Insertar" title="" onMouseOver="goLite(this.form.name,this.name)" onMouseOut="goDim(this.form.name,this.name)" onClick="parent.location='../_ventas/edit2.php?ID_INMUEBLES_MOV=&ID_PROYECTO=&ID_GRUPO=&FECHA_VENTA_DATE=&ID_CLIENTE=&MONTO_VENTA=&ID_INMUEBLES=&FECHA_VENTA_DATE=&FECHA_HASTA=&CODIGO_INMUEBLE=&col=FECHA_VENTA_DATE&orden=1'"><?php } ?></td>
          <td bgcolor="#6FA7D1"><input type="button" name="groovybtn2" class="groovybutton" value="  Buscar" title="" onmouseover="goLite(this.form.name,this.name)" onmouseout="goDim(this.form.name,this.name)" onClick="parent.location='edit.php'" /></td>
        </tr></form>
