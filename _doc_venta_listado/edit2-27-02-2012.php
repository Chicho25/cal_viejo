...
$query_CONSULTA = "SELECT * FROM vista_documentos_ventas ".$where." ORDER BY ".$ordenar." ";
...
<?php if ($totalRows_CONSULTA > 0) { // Show if recordset not empty ?>
	...
	?> >
				...
				<a href="../_ventas_pago/add.php?ID_DOCUMENTO=<?php echo $row_CONSULTA['ID_DOCUMENTO']; ?>&ID_INMUEBLES_MOV=<?php echo $row_CONSULTA['ID_INMUEBLES_MOV'] ?>" title="Nuevo Pagos"><img src="../image/dollar.png" width="24" height="28" /></a>					<?php }?></td>
