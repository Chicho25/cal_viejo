...
<table width="1100" align="center">
	<tr>
	  <td width="33%"  align="right" bgcolor="#F3F3F3" class="textos_form_derecha" >Cuenta:</td>
	  <td width="33%" colspan="3"  bgcolor="#F3F3F3"><select name="ID_CUENTA_BANCARIA" class="textos_form" id="ID_CUENTA_BANCARIA">
          <?php
do {  
?>
...
?>
      ...
      <input type="hidden" name="NOMBRE_TIPO_MOV" id="NOMBRE_TIPO_MOV" />
     <!-- <input name="ANULADO" type="hidden" id="ANULADO" value="" />--></td>
    </tr>
	<tr>
		<td  align="right" bgcolor="#F3F3F3" class="textos_form_derecha" >Tipo Movimiento:</td>
		<td  bgcolor="#F3F3F3"><label for="TIPO_IO"></label>
		...
		<td  align="right" bgcolor="#F3F3F3" class="textos_form_derecha" >Tipo:</td>
		<td  bgcolor="#F3F3F3"><label for="ID_TESORERIA_TIPO_MOV"></label>
...
?>
	...
	<tr>
	  <td  align="right" bgcolor="#F3F3F3" class="textos_form_derecha" >Numero:</td>
	  <td colspan="3"  bgcolor="#F3F3F3"><label for="NUMERO_PAGO"></label>
      <input type="text" name="NUMERO_PAGO" id="NUMERO_PAGO" /></td>
    </tr>
	<tr>
		<td  align="right" bgcolor="#F3F3F3" class="textos_form_derecha" >Desde</td>
		<td  bgcolor="#F3F3F3"><input type="text" id="from" name="FROM"/></td>
		<td width="162" align="right"  bgcolor="#F3F3F3"><span class="textos_form_derecha">Hasta</span></td>
		<td width="33%"  bgcolor="#F3F3F3"><input type="text" id="to" name="TO"/></td>
	</tr>
	<tr>
		<td  align="right" bgcolor="#F3F3F3" class="textos_form_derecha" >Anulado:</td>
		<td  bgcolor="#F3F3F3"><input name="ANULADO" type="checkbox" id="ANULADO" value="AND ANULADO=1" />
			<label for="ANULADO"></label></td>
		<td width="162" align="right"  align="right" bgcolor="#F3F3F3" class="textos_form_derecha" >Cheques Directos</td>
		<td width="33%"  bgcolor="#F3F3F3"><input name="DIRECTO" type="checkbox" id="DIRECTO" value="AND ID_TESORERIA_TIPO_MOV=11" /></td>
	</tr>
	<tr>
		<td colspan="4" align="center"  bgcolor="#F3F3F3" class="textos_form"><input name="button" type="submit" class="ui-widget-header" id="button" value="Buscar" /></td>
	</tr>
</table>
</form>
