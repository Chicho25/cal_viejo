        ...
        <div align="center" id="header">
            <table width="990" border="0" align="center" cellspacing="0" cellpadding="0">
                <tr>
                    <?php
                    mysql_select_db($database_conexion, $conexion);
                    $sqlLogin = mysql_query("SELECT * FROM usuarios_master WHERE ID_USUARIO = '" . $_SESSION['i'] . "' AND partidasUser = '1'", $conexion) or die(mysql_error());
//                    $info = mysql_fetch_array($sqlLogin);
                    $userTop = mysql_num_rows($sqlLogin);
                    //if ($loginRows > 0) {
                    if ($userTop > 0) {
                        ?>
                        <td align="right"><a href="../include/salir.php" class="ui-widget-header" style="text-decoration:none">Cerrar Sesion de <?php echo $nombre; ?></a><a href="../include/ayudas.php"><img src="../img/Ayuda.jpg" width="32" height="32"></a><a id="btnBackUp" style="margin-left:15px; background-color: #992727; font-size: 12px; border: 1px black solid; color:white; padding-left:6px;padding-right:6px; cursor:pointer;">Back-Up</a></td>    
                        <?php
                    } else {
                        ?>
    ...
    <!--    <td align="center"><img src="../img/Fondo_Header1.jpg" width="990" height="140"></td>
        ...
        echo '<script language="javascript">alert("Usted est� entrando a un �rea restringida. Por favor utilice un usuario y una clave v�lidos para ingresar al Sistema.");location.href="../index.php";</script>';
    }
    ?>
