...
$query_CONSULTA = "SELECT * FROM vista_documentos ".$where.$fecha.$fecha1." ORDER BY ".$ordenar." ";
...
<!--pruebas--><td width="100" align="center" bgcolor="#cccccc" class="textos_form">
	...
	//if ($row_CONSULTA['ID_INMUEBLES_MOV_DETALLE']==NULL){ ?><?php if ($row_CONSULTA['TIENE_PAGOS']==1){?>
				<a href="../pagos/list.php?ID_PAGO=&PROYECTO=&proveedores=&TIPO=&NUMERO=&FROM=&TO=&titulo_formulario=Emision+de+Pagos&modulo=1&buscar=Aceptar&ID_DOCUMENTO=<?php echo $row_CONSULTA['ID_DOCUMENTO']; ?>&STATUS=2" title="Ver Pagos"><img src="../image/dollar.png" width="24" height="28" /></a>					<?php }?></td><?php } ?>
