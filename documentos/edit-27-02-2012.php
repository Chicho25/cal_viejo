...
<table width="1100" border="0" cellpadding="0" cellspacing="2" align="center">
	<tr>
		<td width="346" colspan="2" bgcolor="#F0F0F0" class="textos_form_derecha">ID Documento</td>
		<td width="654" colspan="2" bgcolor="#F0F0F0"><span class="textos_form">
	...
	<tr>
	  <td colspan="2" bgcolor="#F0F0F0" class="textos_form_derecha">Proveedor:</td>
	  <td width="654" colspan="2" bgcolor="#F0F0F0"><span class="textos_form">
...
?>
	...
	<tr>
		<td colspan="2" bgcolor="#F0F0F0" class="textos_form_derecha">Tipo:</td>
		<td width="654" colspan="2" bgcolor="#F0F0F0"><label for="TIPO"></label>
...
?>
	...
	<tr>
		<td colspan="2" bgcolor="#F0F0F0" class="textos_form_derecha">Proyecto:</td>
		<td colspan="2" bgcolor="#F0F0F0"><label for="PROYECTO"></label>
...
?>
	...
	<tr>
		<td height="23" colspan="2" bgcolor="#F0F0F0" class="textos_form_derecha">Status:</td>
		<td colspan="2" bgcolor="#F0F0F0"><label for="select2"></label>
	...
	<tr>
		<td colspan="4" align="center" bgcolor="#F0F0F0" class="textos_form"><input name="button" type="submit" class="textos_form" id="button" value="Buscar" /></td>
		</tr>
</table>
</form>
