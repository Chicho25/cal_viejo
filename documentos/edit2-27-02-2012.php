...
<!--pruebas--><td width="100" align="center" bgcolor="#cccccc" class="textos_form">
	...
	//if ($row_CONSULTA['ID_INMUEBLES_MOV_DETALLE']==NULL){ ?><?php if ($row_CONSULTA['TIENE_PAGOS']==1){?>
				<a href="../pago_eliminar/del01.php?PROYECTO=&PROVEEDOR=&TIPO=&NUMERO=&FROM=&TO=&ID_DOCUMENTO=<?php echo $row_CONSULTA['ID_DOCUMENTO']; ?>" title="Ver Pagos"><img src="../image/dollar.png" width="24" height="28" /></a>					<?php }?></td><?php } ?>
