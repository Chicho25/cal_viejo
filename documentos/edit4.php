...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE documentos SET NUMERO=%s, ID_PRO_CLI=%s, TIPO=%s, FECHA_EMISION=%s, FECHA_VENCIMIENTO=%s, DESCRIPCION=%s, ID_PARTIDA=%s, MONTO_EXENTO=%s, MONTO_GRABADO=%s, MONTO_IMPUESTO=%s WHERE ID_DOCUMENTO=%s",
...
<table width="1100" align="center" class="ui-widget-header" >
	<tr>
		<td width="100%" align="center" class="textos_form"><div class="titulo_formulario">Editar Documentos Sin Abonos</div>
	</tr>
...
<table width="1100" border="0" cellpadding="0" cellspacing="2" align="center"><tr>
	...
	<tr>
		...
		<td width="654" bgcolor="#F0F0F0"><input name="COD_PROYECTO"  id="COD_PROYECTO" value="<?php echo $row_proyectos['CODIGO']?>" type="hidden"/>
			<select name="COD_PROYECTO_NOMBRE" id="COD_PROYECTO_NOMBRE" disabled="disabled">
			  <?php
do {  
?>
...
?>
	  ...
	  <input name="id_documento" type="hidden"  id="id_documento" value="<?php echo $row_documento['ID_DOCUMENTO']; ?>" /></td>
	</tr>
	<tr>
		<td bgcolor="#F0F0F0" class="textos_form_derecha">Proveedor:</td>
		<td width="654" bgcolor="#F0F0F0"><label for="ID_PRO_CLI"></label><select name="ID_PRO_CLI" id="ID_PRO_CLI" style="width: 300px; font-size:10px" width="300">
