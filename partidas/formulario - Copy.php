...
mysql_select_db($database_conexion, $conexion);
$query_rst_centro_costos = "SELECT ID_CUENTA FROM vista_contabilidad_cuentas WHERE TIENE_HIJOS =1 AND ID_CUENTA =".$_POST['ID_CENTRO'];
...
mysql_select_db($database_conexion, $conexion);
$query_rst_centro_costo = "SELECT ID_CUENTA, DESCRIPCION FROM contabilidad_cuentas WHERE TIPO = 11 AND ID_SUCURSAL=".$sucursal;
    ...
    <tr valign="baseline">
      ...
      <td><span id="spryselect1">
        ...
        <select name="ID_GRUPO" id="ID_GRUPO">
          <option value="202">Principal</option>
          <?php
do {  
?>
