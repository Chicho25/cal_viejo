...
while($filamenu = mysql_fetch_assoc($rst_consulta)) { ?>
	<li><a onClick="javascript:cesta('<?php echo $filamenu['ID']; ?>')"><?php //echo $filamenu['ID']; ?> <?php echo $filamenu['DESCRIPCION']; ?> <?php //echo $filamenu['NIVEL']; ?></a>
 	<ul>
 	<?php $id=$filamenu['ID']; ?>
	...
	while($filasub = mysql_fetch_assoc($rst_consultas)){ ?> 
    	 		<li><a onClick="javascript:cesta('<?php echo $filasub['ID']; ?>')"><?php //echo $filasub['ID']; ?> <?php echo $filasub['DESCRIPCION']; ?> <?php //echo $filasub['NIVEL']; ?></a>
				<ul>
				...
				while($filasub_1 = mysql_fetch_assoc($submenu_1)){ ?>
					<li><a onClick="javascript:cesta('<?php echo $filasub_1['ID']; ?>')"><?php //echo $filasub_1['ID']; ?> <?php echo $filasub_1['DESCRIPCION']; ?> <?php //echo $filasub_1['NIVEL']; ?></a>
					<ul>
					...
					while($filasub_2=mysql_fetch_assoc($submenu_2)){ ?>
				    	<li><a onClick="javascript:cesta('<?php echo $filasub_2['ID']; ?>')"><?php //echo $filasub_2['ID']; ?> <?php echo $filasub_2['DESCRIPCION']; ?> <?php //echo $filasub_2['NIVEL']; ?></a>
				  		<ul>
						...
						while($filasub_3=mysql_fetch_assoc($submenu_3)){ ?>
				    		<li><a onClick="javascript:cesta('<?php echo $filasub_3['ID']; ?>')"><?php //echo $filasub_3['ID']; ?> <?php echo $filasub_3['DESCRIPCION']; ?> <?php //echo $filasub_3['NIVEL']; ?></a>
				   			<ul>
							...
							while($filasub_4=mysql_fetch_assoc($submenu_4)){ ?>
				      			<li><a onClick="javascript:cesta('<?php echo $filasub_4['ID']; ?>')"><?php //echo $filasub_4['ID']; ?> <?php echo $filasub_4['DESCRIPCION']; ?> <?php //echo $filasub_4['NIVEL']; ?></a>
				     			<ul>
								...
								while($filasub_5=mysql_fetch_assoc($submenu_5)){ ?>
				        			<li><a onClick="javascript:cesta('<?php echo $filasub_5['ID']; ?>')"><?php //echo $filasub_5['ID']; ?> <?php echo $filasub_5['DESCRIPCION']; ?> <?php //echo $filasub_5['NIVEL']; ?></a>
						        	<ul>
									...
									while($filasub_6=mysql_fetch_assoc($submenu_6)){ ?>
							     		<li><a onClick="javascript:cesta('<?php echo $filasub_6['ID']; ?>')"><?php //echo $filasub_6['ID']; ?> <?php echo $filasub_6['DESCRIPCION']; ?> <?php //echo $filasub_6['NIVEL']; ?></a>
								   	    <?php } ?>
                                        <?php } ?>
				        			</ul>
                                    </li>
