...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO partidas (DESCRIPCION, DESCRIPCION_COMPLETA, DESCRIPCION_CORTA, COD_PROYECTO, ID_GRUPO, TIPO, NIVEL, ID_INMUEBLES_GRUPO, MONTO_ESTIMADO) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString(utf8_decode($_POST['DESCRIPCION_COMPLETA1'].$_POST['DESCRIPCION_COMPLETA2']), "text"),
                       GetSQLValueString(utf8_decode($_POST['DESCRIPCION_CORTA1'].$_POST['DESCRIPCION_CORTA2']), "text"),
...
Proyecto: 
      <td width="777" align="left" bgcolor="#F3F3F3" ><label for="NOMBRE_PROYECTO"></label>
      	...
      	<input name="COD_PROYECTO" type="hidden" id="COD_PROYECTO" value="<?php echo $row_PROYECTO['CODIGO']; ?>" />      </tr>
    <tr>
    <tr>
      <td width="311" align="right" bgcolor="#F3F3F3" class="textos_form_derecha" > Partida Grupo: 
      <td align="left" bgcolor="#F3F3F3" ><label for="textfield"></label>
      	<input name="textfield" type="text" class="textos_form" id="textfield" value="<?php echo $row_PARTIDA['DESCRIPCION_COMPLETA']; ?>" size="100" readonly="readonly" />
      	<label for="NOMBRE_PROYECTO">
      		<input name="ID_GRUPO" type="hidden" id="ID_GRUPO" value="<?php echo $row_PARTIDA['ID']; ?>" />
      	</label>      
      	<input name="NIVEL" type="hidden" id="NIVEL" value="<?php echo $row_PARTIDA['NIVEL']+1; ?>" />
      </tr>
    <tr>
      <td width="311" align="right" bgcolor="#F3F3F3" class="textos_form_derecha" >Descripcion Partida:      
      <td align="left" bgcolor="#F3F3F3" ><label for="MONTO_ESTIMADO"><?php echo $row_PARTIDA['DESCRIPCION_COMPLETA']; ?></label>      <label for="DESCRIPCION_COMPLETA2"></label>
      	--&gt;<span id="sprytextfield1">
      	<input name="DESCRIPCION_COMPLETA2" type="text" id="textfield3" size="50" />
      	<span class="textfieldRequiredMsg">Requerido.</span></span>
      	<input name="DESCRIPCION_COMPLETA1" type="hidden" id="DESCRIPCION_COMPLETA1" value="<?php echo $row_PARTIDA['DESCRIPCION_COMPLETA']; ?> --> " />
      </tr>
    <tr><?php 
	$maximo=50-strlen($row_PARTIDA['DESCRIPCION_CORTA']);
	?>
      <td width="311" align="right" bgcolor="#F3F3F3" class="textos_form_derecha" >Descripcion Corta:      
      <td align="left" bgcolor="#F3F3F3" ><label for="DESCRIPCION_CORTA2"><?php echo $row_PARTIDA['DESCRIPCION_CORTA']; ?></label> 
      	/     
      		<label for="DESCRIPCION_COMPLETA2"></label>
      		<span id="sprytextfield2">
      		<input name="DESCRIPCION_CORTA2" type="text" id="textfield2" maxlength="<?php echo $maximo ?>" />
      		<span class="textfieldRequiredMsg">Requerido.</span></span> (Maximo <?php echo $maximo ?> caracteres)     
      		<input name="DESCRIPCION_CORTA1" type="hidden" id="DESCRIPCION_CORTA1" value="<?php echo $row_PARTIDA['DESCRIPCION_CORTA']; ?>/" />
      </tr>
    <tr>
...
<?php if ($_GET['TIPO']==1){ ?><input name="MONTO_ESTIMADO" type="text"  class="textos_form_derecha" readonly="readonly" id="textfield6" value="0"  /><?php } else { ?><input name="MONTO_ESTIMADO" type="text"  class="textos_form_derecha"  id="textfield6" value="0"  /><?php } ?>
<span class="textfieldRequiredMsg">Requerido.</span><span class="textfieldInvalidFormatMsg">Debe ser numerico.</span></span>
