...
$(document).ready(function(){
        ...
        function DoSomething() {
			http://localhost/calpe/sistema/_cheque/add2.php?CUENTA=1&cheque=2376&MONTO=323&MONTO_LETRAS=Trescientos+veintitres&BENEFICIARIO=vasvasv&DESCRIPCION=dbasbasv&aceptar=Aceptar
...
<table width="1100" border="0" cellpadding="2" cellspacing="2" align="center">
	<tr>
	  ...
	  <td bgcolor="#F0F0F0" class="textos_form"><input name="CHEQUE" type="text" class="textos_form_derecha" value="<?php echo $_GET['cheque'] ?>" readonly="readonly" />
	...
	<tr>
	  ...
	  <td bgcolor="#F0F0F0" class="textos_form"><input name="textfield" type="text" class="textos_form" id="textfield" value="<?php echo $row_CHEQUE['NUMERO_CUENTA']; ?>" size="70" readonly="readonly" /></td>
    </tr>
	<tr>	<?php  
 $MONTO=$_GET['MONTO'];
...
?>
	  <td bgcolor="#F0F0F0" class="textos_form_derecha"><input name="FECHA" type="hidden" id="FECHA" value="<?php echo DMAtoAMD($_GET['FECHA']) ?>" />
	...
	<tr>
	  <td colspan="2" align="center" bgcolor="#F0F0F0" class="textos_form"><input name="button3" type="submit" class="ui-widget-header" id="button3" value="Guardar" />	    <input name="button" type="button" class="ui-state-error" id="button" value="Anular Cheque" onClick="window.location='cheque_anulado.php?CHEQUE=<?php echo $_GET['cheque']; ?>&ID_CUENTA=<?php echo $row_CHEQUE['ID_CUENTA_BANCARIA']; ?>&ID_CHEQUERA=<?php echo $row_CHEQUE['ID_CHEQUERA']; ?>&COD_PROYECTO=<?php echo $row_CHEQUE['CODIGO_PROYECTO']; ?>'" /></td>
	</tr>
</table>
</form><center>
...
<iframe height="400" width="1000" src="print.php?ID_PAGO=<?php echo $_GET['cheque'] ?>&BENEFICIARIO=<?php echo $_GET['BENEFICIARIO'] ?>&DESCRIPCION=<?php echo $_GET['DESCRIPCION'] ?>&MONTO=<?php echo $_GET['MONTO']; ?>&MONTO_LETRAS=<?php echo $_GET['MONTO_LETRAS']; ?>"></iframe>
</center>
