...
<iframe height="400" width="1000" src="print.php?ID_PAGO=<?php echo $_GET['ID_PAGO'] ?>&BENEFICIARIO=<?php echo $_GET['BENEFICIARIO'] ?>&DESCRIPCION=<?php echo $_GET['DESCRIPCION'] ?>&MONTO=<?php echo $_GET['MONTO'] ?>&MONTO_LETRAS=<?php echo $_GET['MONTO_LETRAS'] ?>"></iframe></center>
