...
$(document).ready(function(){
        ...
        function DoSomething() {
            ...
            //local_id = current_id;
			var url = "_add.php?BENEFICIARIO=<?php echo $_GET['BENEFICIARIO']; ?>&MONTO=<?php echo $_GET['MONTO']; ?>&CHEQUE=<?php echo $_GET['CHEQUE']; ?>&DESCRIPCION=<?php echo $_GET['DESCRIPCION']; ?>&ID_CUENTA_BANCARIA=<?php echo $_GET['ID_CUENTA_BANCARIA']; ?>"; 
			window.location =   url; 
