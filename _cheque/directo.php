...
$query_CUENTAS = "SELECT * FROM vista_banco_chequeras WHERE AUTOMATICA=1 AND CHEQUERA_FINALIZADA=0";
...
<?php
/*Definiciones*/
$formulario="Banco01-Cheque directo";
?>
...
<form name="enviar" method="GET" id="enviar" action="add.php">
...
do {  
?>
		<option value="<?php echo $row_CUENTAS['ID_CHEQUERA']?>"<?php if (!(strcmp($row_CUENTAS['ID_CHEQUERA'], $row_CUENTAS['ID_CHEQUERA']))) {echo "selected=\"selected\"";} ?>><?php echo $row_CUENTAS['NOMBRE_PROYECTO']; ?>-<?php echo $row_CUENTAS['NOMBRE_BANCO']; ?>-<?php echo $row_CUENTAS['NUMERO_CUENTA']?></option>
		<?php
