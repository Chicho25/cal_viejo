<?php 
$colname_rst_clientes = "-1";
if (isset($_GET['buscar']) && !empty($_GET['buscar'])){
  $colname_rst_clientes = $_GET['buscar'];
}
mysql_select_db($database_conexion, $conexion);
$query_rst_clientes = "SELECT * FROM vista_pro_cli WHERE ID_PRO_CLI <> '' ".isset_or($_GET['nombre'])." ".isset_or($_GET['tipo'])." ".isset_or($_GET['contacto'])." ".isset_or($_GET['documentos'])." ";
