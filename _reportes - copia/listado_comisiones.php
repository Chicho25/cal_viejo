...
$col1="CODIGO_INMUEBLE";
$col2="NOMBRE_VENDEDOR";
$col3="NOMBRE_CLIENTE";
$col4="PORCENTAJE_COMISION";
$col5="MONTO_COMISION";
$columnas=" '',".$col1.", ".$col2.", ".$col3.", ".$col4.", ".$col5." ";
$titulo_col1="CODIGO INMUEBLE";
$titulo_col2="NOMBRE VENDEDOR";
$titulo_col3="CLIENTE";
$titulo_col4="PORCENTAJE";
$titulo_col5="MONTO";
...
$query_CONSULTA = "SELECT ".$columnas." FROM vista_comisiones_venta ";//.$where." ORDER BY ".$ordenar;
