...
<?php include('../include/header.php'); ?>
    <?php if(isset($_GET['ID_CUENTA_BANCARIA']))  { $activa=0;
	 }else {$activa=1;};?>    
...
<script>
	...
	aud($_SESSION['i'],'','Ingreso al modulo',$_GET['id_menu']);
	 ?>
<h1 align="center"><?php echo $_GET['titulo_formulario'] ?></h1>
<div id="accordion">
		<?php if(isset($_GET['ID_CUENTA_BANCARIA']) && $_GET['ID_CUENTA_BANCARIA']!="") { ?>
		  <h3><a href="#">Editar</a></h3>
		  <div><?php include('edit.php');?></div>
          <?php } ?>
          <?php if (validador($_GET['id_menu'],$_SESSION['i'],"inc")==1){?>
